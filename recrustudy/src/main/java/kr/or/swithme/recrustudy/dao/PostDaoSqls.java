...
public class PostDaoSqls {
	...
	public static final String SELECT_BY_COMMENT="SELECT p.post_id, p.member_id, p.title FROM Post AS p JOIN Comment AS c ON p.post_id = c.post_id WHERE c.member_id = :member_id";
